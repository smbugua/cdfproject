<?php
include('header.php');
$result=mysql_query("SELECT * FROM assets ORDER BY id ASC");
                    ...
                    <div class="ibox">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a href="addasset.php" class="btn btn-primary btn-xs">Add Assets</a>
                            </div>
                        </div>
...
<table class="table table-bordered  dataTables-example"  align="center" id="tableid" datapagesize="20"   >
        ...
        <h4>Assets Details</h4>         
                ...
                <tr> 
                    <th class="header" id="usr">Assets Name</th> 
                    <th class="header" id="usr">Asset Type</th> 
                    <th class="header" id="usr">Asset Condition</th>
