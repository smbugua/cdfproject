                    ...
                    <div class="ibox">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a href="addboard.php" class="btn btn-primary btn-xs">Add New Member</a>
                            </div>
                        </div>
...
<table class="table table-bordered  dataTables-example"  align="center" id="tableid" datapagesize="20"   >
        ...
        <h4>Member Details</h4>         
                ...
                <tr> 
                    <th class="header" id="usr">Name</th> 
                    <th class="header" id="usr">Phone Number</th> 
                    <th class="header" id="usr">ID Number</th>
                    <th class="header" id="usr">Position</th>
