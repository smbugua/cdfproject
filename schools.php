                    ...
                    <div class="ibox">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a href="addschool.php" class="btn btn-primary btn-xs">Create new School</a>
                            </div>
                        </div>
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        <td class="project-status">
                                            <span class="label label-primary"><?php echo $row['school_code']?></span>
                                        </td>
                                        <td class="project-title">
                                            <a href="school_detail.php?id=<?php echo $row['id']?>"><?php echo $row['school_name']?></a>
                                            <br/>
                                            <small>Created <?php echo $row['dateadded']?></small>
                                        </td>
                                        <td class="project-completion">
                                                <small><?php echo $row['ward_location']?></small>
