<?php
include('header.php');
$result=mysql_query("SELECT * FROM voucher ORDER BY id DESC");
                    ...
                    <div class="ibox">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a href="addvoucher.php" class="btn btn-primary btn-xs">New Voucher</a>
                            </div>
                        </div>
...
<table class="table table-bordered  dataTables-example"  align="center" id="tableid" datapagesize="20"   >
        ...
        <h4>Voucher Description</h4>         
                ...
                <tr> 
                    <th class="header" id="usr">Voucher code</th> 
                    <th class="header" id="usr">Subject</th> 
                      <th class="header" id="usr">Amount</th> 
                    <th class="header" id="usr">Description</th>
            ...
            <?php while ($row = mysql_fetch_array($result)) { ?>           
                <tr > 
                    ...
                    <td><?php echo $row["voucher_subject"]?></td>
